...
function getRandomReview(){
  request.get({
    ...
    var randomReview = Math.floor(Math.random() * results.length);
    var review = results[randomReview];
    if (review.link.url.includes("http://www.nytimes.com/https://")){
      var fixedUrl = review.link.url.split("http://www.nytimes.com/")[1];
      review.link.url = fixedUrl;
    }
